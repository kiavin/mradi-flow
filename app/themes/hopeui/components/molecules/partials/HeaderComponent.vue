...
import DefaultNavbar from '~/themes/hopeui/components/organisms/navbar/DefaultNavbar.vue'
import RadioInput from '~/themes/hopeui/components/atoms/input/RadioInput.vue'
  ...
  <default-navbar @menuOpen="showOffcanvas" @menuClose="hideOffcanvas">
    <template v-slot:navbar-buttons-start>
      <li class="nav-item dropdown me-0 me-xl-3">
        <div
          class="d-flex align-items-center mr-2 iq-font-style"
          role="group"
          aria-label="First group"
        >
          <radio-input
            btn-name="theme_font_size"
            id="font-size-sm"
            label-class="border-0 btn-icon btn-sm"
            :default-checked="fontSize"
            value="theme-fs-sm"
            @onChange="store.theme_font_size"
          >
