...
<template>
  <div class="card p-3">
    ...
    <div class="row d-flex justify-content-between align-items-center">
      <div class="col-auto">
        <h1 class="h1 mt-2">View ProjectFinancier</h1>
      </div>
      <div class="col-auto">
        <Button type="submit" customClass="btn btn-primary" @click="() => {router.push({ name: 'project/projectfinancier/update', params: { id } });}"> Edit </Button>
      </div>
    </div>
