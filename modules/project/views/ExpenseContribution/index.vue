...
const apiBaseUrl = `/v1/project/expense-contributions`
...
// router.push({ name: 'project/expensecontribution/view', params: { id } });
//};
...
const handleView = async (row) => {
  ...
  const apiBaseUrl = `/v1/project/expense-contribution/${id}`
  ...
  modalStore.openModal(
    ...
    'View ExpenseContribution',
  )
}

//const handleEdit = (id) => {
//   router.push({ name: 'project/expensecontribution/update', params: { id } });
//}
...
const handleDelete = async (row) => {
  ...
  if (result.isConfirmed) {
    try {
      ...
      const { data, request, isLoading } = useApi(`/v1/project/expense-contribution/${id}`, {
        method: 'DELETE',
      })
...
<template>
  <div class="card p-3">
    <div class="row d-flex justify-content-between align-items-center mb-3">
      <div class="col-auto">
        <h1 class="h4 mt-2">List of ExpenseContribution</h1>
      </div>
