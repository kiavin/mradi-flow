...
const tableColumns = [{"key":"name","label":"Name"},{"key":"description","label":"Description"},{"key":"ruleName","label":"RuleName"}]
...
// router.push({ name: 'iam/permissions/view', params: { id } });
//};
...
const handleView = async (id) => {
  ...
  const apiBaseUrl = `/v1/iam/permissions/${id}`;
...
//const handleEdit = (id) => {
//   router.push({ name: 'iam/permissions/update', params: { id } });
//}
...
const handleCreate = async() => {
  ...
  if (!modalStore.useModal) {
    router.push({ name: 'iam/permissions/create' })
    return
  }
...
<template>
  <div class="card p-3">
   <div class="row d-flex justify-content-between align-items-center mb-3">
      <div class="col-auto">
        <h1 class="h4 mt-2">List of Permissions</h1>
      </div>
      <div class="col-auto mb-4">
        <Button type="submit" customClass="btn btn-primary" @click="handleCreate"> New Permissions </Button>
      </div>
